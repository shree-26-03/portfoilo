...
const About = () => {
  ...
  return (
    <div className="about">
      ...
      <p>
        I am Suvendu. A self taught java and frontend Developer 💻.I was
        interested in computers from childhood,so I persued my career in
        software development. I don't like to be language specific, I love
        working 🔨💡 in different languages and exploring new stuff 🚀.
        <br />
        <br />
        <br />
